package net.omaima.chatbottelegram.telegram;

import jakarta.annotation.PostConstruct;
import net.omaima.chatbottelegram.agents.AIAgent;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public TelegramBot(AIAgent aiAgent) {
        this.aiAgent = aiAgent; //injection de dependances
    }

    //au demarrage l agent va faire un subscribe vers l'api en utilisant la cle api
    @PostConstruct
